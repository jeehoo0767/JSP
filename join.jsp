		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form method="post" action="joinAction.jsp">
					...
					<div class="form-group">
						<div class="btn-groub" data-toggle="buttons">
							<label class="btn btn-primary active">
								<input type="radio" class="form-control" autocomplete="off" value="남자" name="userGender" checked>남자
							</label>
							<label class="btn btn-primary active">
								<input type="radio" class="form-control" autocomplete="off" value="여자" name="userGender">여자
							</label>
						</div>
					</div>
